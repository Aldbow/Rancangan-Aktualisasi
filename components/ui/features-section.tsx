      ...
      <Card className="bg-gradient-to-br from-slate-50/80 to-white/50 dark:from-slate-800/80 dark:to-slate-700/50 border-0 shadow-2xl rounded-3xl overflow-hidden backdrop-blur-sm">
        <CardContent className="p-6 sm:p-8 lg:p-12">
          <div className="text-center mb-10 lg:mb-16 px-4 sm:px-6">
            <h2 className="text-2xl sm:text-3xl lg:text-4xl font-bold bg-gradient-to-r from-blue-700 to-blue-600 dark:from-blue-400 dark:to-blue-300 bg-clip-text text-transparent mb-4 lg:mb-6">
              Fitur Utama
            </h2>
            <p className="text-slate-600 dark:text-slate-300 text-base sm:text-lg lg:text-xl max-w-3xl mx-auto">
              ...
              return (
                <div key={index} className="text-center group">
                  <div className="relative h-full">
                    <div className={`p-6 lg:p-8 ${feature.bgColor} rounded-3xl w-full mx-auto mb-6 lg:mb-8 shadow-lg`}>
                      <div className={`p-5 lg:p-6 bg-gradient-to-br ${feature.color} rounded-2xl w-fit mx-auto mb-6 shadow-lg`}>
                        <Icon className="h-10 w-10 lg:h-12 lg:w-12 text-white" />
                      </div>
                    </div>
                    
                    <h3 className="text-xl lg:text-2xl font-bold text-slate-800 dark:text-white mb-4 lg:mb-5">
                      {feature.title}
                    </h3>
                ...
                >
                  <div className="relative h-full">
                    ...
                    >
                      ...
                      <div className={`absolute inset-0 bg-gradient-to-br ${feature.color} opacity-0 group-hover:opacity-20 rounded-3xl blur-2xl transition-opacity duration-500 z-0`}></div>
