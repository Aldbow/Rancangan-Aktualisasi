    ...
    <html lang="id">
      ...
      <body className={`${inter.variable} font-sans`}>
        ...
        >
          ...
          <header className="bg-gradient-to-r from-blue-700 to-blue-800 dark:from-slate-800 dark:to-slate-900 shadow-lg">
            <div className="max-w-7xl mx-auto px-2 sm:px-4 lg:px-8">
              <div className="flex justify-between items-center py-4 lg:py-6">
                <div className="flex items-center space-x-2 lg:space-x-3">
                  <div className="w-8 h-8 lg:w-10 lg:h-10 bg-white rounded-lg flex items-center justify-center p-1">
                    <Image 
                ...
                <nav className="flex items-center space-x-1 sm:space-x-2">
                  ...
                  <a href="/dashboard" className="text-blue-100 hover:text-white hover:bg-blue-600 px-2 sm:px-3 lg:px-4 py-2 rounded-lg text-xs sm:text-sm font-medium transition-all duration-300 hover:scale-105 hover:shadow-lg hover:shadow-blue-500/25">
                    Dashboard
                  </a>
                  <ThemeToggle />
                </nav>
